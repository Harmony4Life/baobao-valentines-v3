...
no.addEventListener("click", () => {
  if (count == 2) {
    ...
    text.innerHTML = "BAOBAO. WHY YOU PRESS NO? U MEANT YES, RIGHT?";
    yes.style.height = "65%";
    yes.style.width = "60%";
    no.style.width = "30%";
    count++;
    ...
    text.innerHTML = "AMOOOOO HOW CAN YOUR HAND SLIP TWICE? PRESS YES PLEASE";
    yes.style.height = "70%";
    yes.style.width = "70%";
    no.style.width = "20%";
    count++;
    ...
    text.innerHTML = "AMMM TAMTRUMSSSS";
    yes.style.height = "80%";
    yes.style.width = "80%";
...
yes.addEventListener("click", () => {
  ...
  text.innerHTML = "That's a good girl... I love you, my perfect valentine girl <3";
  yes.innerHTML = '<a href="https://www.instagram.com/myp_.jfy/">Message me</a>';// inside the " " put your social media profile link
  yes.style.height = "90%";
  yes.style.width = "96%";
  no.style.display = "none";
  setTimeout(() => {
